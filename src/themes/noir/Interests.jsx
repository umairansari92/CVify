      ...
      <div className="mx-auto max-w-[1400px]">
        ...
        <div className="mb-14 flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div>
            <div className="mb-6 flex items-center gap-4">
              <span className="text-[10px] uppercase font-bold tracking-widest" style={{ fontFamily: tokens.fonts.mono, color: tokens.colors.secondary }}>(10)</span>
        ...
        <div className="flex flex-wrap gap-4">
          {interests.map((interest, i) => {
            const interestName = typeof interest === 'string' ? interest : interest?.name || interest?.interest || "";
