  ...
  return (
    <div className="max-w-5xl mx-auto py-12 px-6 space-y-8 animate-fadeIn">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        {activeResume && (
          <div className="px-4 py-2 rounded-xl bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-white/5 flex items-center gap-3">
            <Briefcase size={14} className="text-primary" />
            <div className="flex flex-col">
              <span className="text-[8px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest leading-none">Comparing With</span>
              <span className="text-xs font-bold text-slate-900 dark:text-white mt-1">{activeResume.title || "Untitled Resume"}</span>
            </div>
          </div>
        )}
      </div>
