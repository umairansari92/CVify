...
import { FaFileAlt, FaTrash, FaEye, FaSearch, FaUser } from "react-icons/fa";
              ...
              <div key={r._id} className="premium-card p-6 flex flex-col group hover:border-primary/30 transition-all">
                ...
                <div className="mt-auto pt-6 border-t border-white/5 flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <div className="w-6 h-6 rounded-full bg-primary/20 flex items-center justify-center text-[10px] text-primary"><FaUser /></div>
                    <span className="text-[11px] font-bold text-text-muted truncate max-w-[120px]">@{r.user?.username}</span>
                  </div>
