  ...
  return (
    <div className="space-y-8 animate-fadeIn">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-black tracking-tighter capitalize">Designer Studio</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
           ...
           <div className="space-y-3">
              {fonts.map(font => (
                <button 
                  ...
                  className={`w-full text-left px-5 py-4 rounded-2xl border transition-all ${currentResume?.fontFamily === font ? "border-primary bg-primary/5 ring-2 ring-primary/10" : "border-slate-100 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800/50"}`}
        ...
        <div className="bg-white dark:bg-[#111827] border border-slate-200 dark:border-slate-800 rounded-3xl p-8 shadow-sm">
           <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-sm font-black uppercase tracking-widest">Theme Color</h3>
           </div>
           <div className="grid grid-cols-3 gap-4">
              {colors.map(color => (
                <button 
                  ...
                  className={`h-20 rounded-2xl border-4 transition-all ${currentResume?.themeColor === color ? "border-white dark:border-slate-700 shadow-xl scale-105" : "border-transparent opacity-60 hover:opacity-100"}`}
